...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'cdekIntgrate',
                'description' => 'Default source for files of cdekIntgrate',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/cdekintgrate/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'cdekintgrate_source_default'))) {
