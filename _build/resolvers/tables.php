...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('cdekintgrate', MODX_CORE_PATH . 'components/cdekintgrate/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/cdekintgrate/model/schema/cdekintgrate.mysql.schema.xml';
