...
class cdekIntgrateOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('cdekintgrate_item_err_ns');
        }
...
return 'cdekIntgrateOfficeItemUpdateProcessor';
